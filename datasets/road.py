...
class roaddataset(data.Dataset):
   ...
   #                      0, False, True, (0, 0, 0)),
    ...
    def __init__(self, root, split='train', target_type='semantic', transform=None):
        ...
        self.images_dir = os.path.join(self.root, 'image', split)
        self.targets_dir = os.path.join(self.root, 'gtfine', split)
        self.edge_dir = os.path.join(self.root, 'gtfine', split)
        ...
        for road in os.listdir(self.images_dir):
            ...
            self.targetname.append(target_name)
            # if  self.split =='train':
