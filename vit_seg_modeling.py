...
class Block(nn.Module):
    def __init__(self, hidden_size,mlp_dim,num_heads, vis):
...
class Encoder(nn.Module):
    def __init__(self, hidden_size,mlp_dim,num_heads,num_layers,vis):
        super(Encoder, self).__init__()
        self.vis = vis
        self.layer = nn.ModuleList()
        self.encoder_norm = LayerNorm(hidden_size, eps=1e-6)
        for _ in range(num_layers):
            layer = Block(hidden_size,mlp_dim,num_heads, vis)
