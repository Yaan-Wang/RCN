...
def compute_cosine_distance(x, y):
    ...
    # consine similarity
    cosine_sim = torch.mul(x_normalized,y_normalized)  # (N, H*W, H*W)
    # print(cosine_sim.size())
    cosine_sim1=cosine_sim/torch.abs( x_normalized+y_normalized-cosine_sim+ 1e-5)

    # print(cosine_sim1)
    # cosine_sim = tanimoto_coefficient(x_normalized,
